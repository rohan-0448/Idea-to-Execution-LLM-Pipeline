...
try:
    ...
    raise FileNotFoundError("config.yaml not found.  Please create it.")
except yaml.YAMLError as e:
    raise ValueError(f"Error parsing config.yaml: {e}")

if 'api_key' not in config:
    raise ValueError("Missing 'api_key' in config.yaml")
if 'file_paths' not in config:
    raise ValueError("Missing 'file_paths' in config.yaml")
if 'training_data' not in config['file_paths']:
    raise ValueError("Missing 'training_data' in config['file_paths']")
if 'output_directory' not in config['file_paths']:
    raise ValueError("Missing 'output_directory' in config['file_paths']")
