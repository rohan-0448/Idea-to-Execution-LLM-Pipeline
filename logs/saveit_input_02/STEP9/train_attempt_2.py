...
try:
    ...
    print(f"Successfully loaded data from {training_data_fp}")
except pd.errors.EmptyDataError:
    print(f"Error: The CSV file at {training_data_fp} is empty.")
    raise
except pd.errors.ParserError:
    print(f"Error: Could not parse the CSV file at {training_data_fp}.  Check its format.")
    raise
