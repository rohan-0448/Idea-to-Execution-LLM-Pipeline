...
if 'file_paths' not in config:
    print("Error: 'file_paths' section missing in config.yaml")
    exit()

if 'training_data' not in config['file_paths']:
    print("Error: 'training_data' path missing in config.yaml")
    exit()

if 'output_directory' not in config['file_paths']:
    print("Error: 'output_directory' path missing in config.yaml")
    exit()
